    ...
    <div class="container-fluid">
        <div class="row">
            <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow" style="height: 5vh">
                ...
                <input class="form-control w-76 " type="search" placeholder="Pesquisar" aria-label="Pesquisar" style="border-radius: 0">
                <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Pesquisar</button>
            </nav>


            <nav class="col-md-2 d-none d-md-block sidebar bg-light" style="height: 100vh; border: 1px solid rgba(0,0,0,.125); left: -1rem">
                <div class="sidebar-sticky">
                    <ul id="main-menu" class="nav flex-column" style="margin-top: 3.2rem;">
                        ...
                        <li class="nav-item">
                            <a href="/admin/users" class="nav-link <?php if (resolve('/admin/users.*')) : ?> active <?php endif ?>">
                                <i class="fas fa-user-friends"></i> clientes</a>
                        </li>
                        <li class="nav-item">
                            <a href="/admin/produtos" class="nav-link <?php if (resolve('/admin/produtos.*')) : ?> active <?php endif ?>">
